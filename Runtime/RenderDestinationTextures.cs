...
namespace Barkar.BSRP.CameraRenderer
{
    public readonly ref struct RenderDestinationTextures
    {
        ...
        public RenderDestinationTextures(TextureHandle colorAttachment0, TextureHandle colorAttachment1, TextureHandle colorAttachment2, TextureHandle colorAttachment3, TextureHandle depthAttachment)
        {
